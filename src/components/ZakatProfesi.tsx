...
type ZakatProfesiProps = {
	onHandleCalculate: any;
};

const ZakatProfesi = ({ onHandleCalculate }: ZakatProfesiProps) => {
	const initialInput = {
		penghasilan: {
			value: '',
			isError: false,
		...
		<>
			<Box
				...
				<Text mb={`4`}>
					...
					adalah bagian dari zakat maal yang wajib dikeluarkan atas harta yang
					berasal dari pendapatan / penghasilan rutin dari pekerjaan yang tidak
					melanggar syariah.
				</Text>
				<Text mb={`4`}>
					Nishab zakat penghasilan sebesar 85 gram emas per tahun. Kadar zakat
					penghasilan senilai 2,5%. Dalam praktiknya, zakat penghasilan dapat
					ditunaikan setiap bulan dengan nilai nishab per bulannya adalah setara
					dengan nilai seperduabelas dari 85 gram emas, dengan kadar 2,5%.
				</Text>
				<Text mb={`4`}>
